...
public class SaveQuestionGraphics extends JPanel {
    ...
    private void fillCells1(Graphics g){
        ...
        g.drawString("F", 105, 103);
        g.drawString("T", 105, 172);
    }
    ...
    private void fillCells2(Graphics g){
        ...
        g.setColor(Color.BLACK);
        g.drawString("F", 65, 63);
        g.drawString("F", 65, 103);
        g.drawString("T", 65, 143);
        g.drawString("T", 65, 183);
        g.drawString("F", 165, 63);
        g.drawString("T", 165, 103);
        g.drawString("F", 165, 143);
        g.drawString("T", 165, 183);
    }
